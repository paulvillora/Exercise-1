...
Open Jupyter lab from the [Exercise 1 landing page](https://geo-python-upd.readthedocs.io/en/latest/notebooks/L1/a-taste-of-python.html) on the course site, and create a new notebook.
